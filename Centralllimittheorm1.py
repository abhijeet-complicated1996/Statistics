...
#deviation .
#We can calculate the parameters of this normal distribution and find the cumulative probability
#for x = 9800. Here's my code written in python 3
...
mu_sum = n * mu #new sample mean for central limit theorm
sigma_sum = math.sqrt(n) * sigma #new standard deviation 
